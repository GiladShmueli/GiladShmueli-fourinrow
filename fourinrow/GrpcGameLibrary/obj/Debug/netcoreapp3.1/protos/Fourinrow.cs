...
namespace grpc4InRowService {
  ...
  public static partial class FourinrowReflection {
    ...
    static FourinrowReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChZwcm90b3MvZm91cmlucm93LnByb3RvEglmb3VyaW5yb3ciBwoFRW1wdHki",
  ...
  #endif
  {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      gamesData_.WriteTo(ref output, _repeated_gamesData_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            gamesData_.AddEntriesFrom(ref input, _repeated_gamesData_codec);
            break;
          }
        }
      }
